...
public class UserTest {
  ...
  public void carga_desde_fichero() {
    ...
    es.carm.openldap.dac.dao.dsml.UserFactory dsmlFactory =
        new es.carm.openldap.dac.dao.dsml.UserFactory();
    String dsml = dsmlFactory.toString(ejemplo);
    // System.err.println( "DSML=\n"+ dsml +"\n\n" );
    assertTrue((null != dsml) && (0 < dsml.length()));

    es.carm.openldap.dac.dao.json.UserFactory jsonFactory =
        new es.carm.openldap.dac.dao.json.UserFactory();
