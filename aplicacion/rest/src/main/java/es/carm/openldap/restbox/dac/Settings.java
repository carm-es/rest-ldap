  ...
  public static String getMimeSelectorDefault(String accept) {
    if (!isEmpty(accept)) {
      ...
      if (!isEmpty(prefered)) {
        ...
        } else if ((MIME_LDIF.equalsIgnoreCase(prefered))
            || ("text/directory".equalsIgnoreCase(prefered))) {
          return MIME_LDIF;

        } else if ((MIME_XML.equalsIgnoreCase(prefered))
            || ("application/xml".equalsIgnoreCase(prefered))) {
          return MIME_XML;

        } else if ((MIME_DSML.equalsIgnoreCase(prefered))
            || ("application/dsml".equalsIgnoreCase(prefered))) {
          return MIME_DSML;
        }
      }
    }
